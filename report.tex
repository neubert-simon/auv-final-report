...
Employed attacking techniques will be categorized into the \textbf{Mitre ATT\&CK} framework \autocite{mitre:attack}. Techniques will be named in cursive, followed by their ID in braces.\\[1em]
